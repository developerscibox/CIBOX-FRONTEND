...
const TOP_COLOR = ["#004568", "#003D49", "#003D49", "#003D49", "#B6D900", "#006996"];
...
export default function Ventas() {
  ...
  const kpis = [
    ...
    { ic: "🧾", bg: "#E6F0F5", v: sales.loading ? "…" : (salesT.total_orders ?? 0).toLocaleString("es-CL"), l: `Pedidos pagados · ${range.label}` },
