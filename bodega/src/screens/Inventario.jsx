...
const CAT_COLORS = ["#004568", "#006996", "#2A87B0", "#5AA6C4", "#93C4D8", "#B6D900", "#D2E51A", "#003D49"];
        ...
        <table>
          ...
          <tbody>
            {items.map((it) => {
              ...
              const badgeBg = vencido ? "#fee2e2" : critico ? "#fef3c7" : "#EEF1F4";
  ...
  return (
    <svg viewBox={`0 0 ${size} ${size}`} width={size} height={size} role="img">
      <g transform={`translate(${size / 2},${size / 2}) rotate(-90)`}>
        <circle r={r} fill="none" stroke="#EEF1F4" strokeWidth={thickness} />
...
export default function Inventario({ onNav } = {}) {
  ...
  const kpis = [
    { ic: "📦", bg: "#E6F0F5", v: totals.sku ?? 0, l: "SKUs activos" },
