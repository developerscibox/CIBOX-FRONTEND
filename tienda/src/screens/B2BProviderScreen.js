...
function CtaBanner({ title, body, email }) {
  return (
    <View style={{
      ...
      {email && (
        <Pressable
          onPress={() => Linking.openURL(`mailto:${email}?subject=Formalización Proveedor B2B CIBOX`)}
          style={({ pressed }) => ({
...
function SectionBlock({ section }) {
  ...
  return (
    <View style={{
      ...
      {section.cta && (
        <CtaBanner title={section.cta.title} body={section.cta.body} email={section.cta.email} />
      )}
    </View>
  );
}
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
        <View style={{
          ...
          <View style={{
            ...
            backgroundColor: "rgba(255,255,255,.10)", top: -80, right: -60,
          }} />
          <View style={{
            position: "absolute", width: 180, height: 180, borderRadius: 90,
            backgroundColor: "rgba(255,255,255,.07)", bottom: -60, left: -40,
          }} />
        ...
        <View style={{ paddingHorizontal: spacing.md, paddingTop: spacing.lg }}>
          ...
          <View style={{ borderTopWidth: 1, borderColor: colors.border, paddingTop: 16, marginTop: 6 }}>
